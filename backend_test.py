...
class AstrologyBackendTests(unittest.TestCase):
    ...
    def test_04_daily_horoscope_generation(self):
        """Test daily horoscope generation with different tones"""
        logger.info("Testing daily horoscope generation...")
    ...
    def test_05_compatibility_analysis(self):
        """Test compatibility analysis with partner birth data"""
        logger.info("Testing compatibility analysis...")
